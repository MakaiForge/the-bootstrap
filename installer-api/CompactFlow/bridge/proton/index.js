#!/usr/bin/env node
const { listInstalled } = require('./installed');
const { listAvailable } = require('./available');
const { installProton } = require('./install');
const { listForks, rateReleases } = require('./forks');
